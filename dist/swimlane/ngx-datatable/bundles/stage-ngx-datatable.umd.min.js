!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? t(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('rxjs/operators'))
    : 'function' == typeof define && define.amd
    ? define('@stage/ngx-datatable', ['exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], t)
    : t(
  ...
  (i.decorators = [{ type: t.Injectable }]),
  ...
  a.decorators = [{ type: t.Injectable }];
  var s = (function () {
    function e() {
      this.columnInputChanges = new r.Subject();
    }
    return (
  ...
  s.decorators = [{ type: t.Injectable }];
  var l = function (e) {
    this.template = e;
  };
  (l.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-footer-template]' }] }]),
  ...
  (c.decorators = [{ type: t.Directive, args: [{ selector: '[visibilityObserver]' }] }]),
      ...
      (e.prototype.onMousedown = function (e) {
        ...
        if (e.target.classList.contains('draggable') && (this.dragX || this.dragY)) {
          ...
          var n = { x: e.clientX, y: e.clientY },
            i = r.fromEvent(document, 'mouseup');
          ...
          this.subscription.add(a), this.dragStart.emit({ event: e, element: this.element, model: this.dragModel });
        }
      }),
      (e.prototype.move = function (e, t) {
        if (this.isDragging) {
          ...
          this.dragX && (this.element.style.left = n + 'px'),
            this.dragY && (this.element.style.top = r + 'px'),
  ...
  (u.decorators = [{ type: t.Directive, args: [{ selector: '[draggable]' }] }]),
    ...
    return (
      ...
      (e.prototype.onMousedown = function (e) {
        ...
        if (n) {
          ...
          var s = r.fromEvent(document, 'mouseup');
          this.subscription = s.subscribe(function (e) {
            return t.onMouseup();
          });
          var l = r
            .fromEvent(document, 'mousemove')
      ...
      (e.prototype.move = function (e, t, n) {
        var r = t + (e.screenX - n),
          o = !this.minWidth || r >= this.minWidth,
          i = !this.maxWidth || r <= this.maxWidth;
        o && i && (this.element.style.width = r + 'px');
      }),
      (e.prototype._destroySubscription = function () {
        this.subscription && (this.subscription.unsubscribe(), (this.subscription = void 0));
      }),
  ...
  var f = (function () {
    ...
    return (
      ...
      (e.prototype.updateSubscriptions = function () {
        ...
        if (t) {
          ...
          t.forEachAddedItem(function (t) {
            ...
            n({ previousValue: o }),
              r &&
                (r.dragStart.subscribe(e.onDragStart.bind(e)),
                r.dragging.subscribe(e.onDragging.bind(e)),
                r.dragEnd.subscribe(e.onDragEnd.bind(e)));
          }),
      ...
      (e.prototype.onDragStart = function () {
        ...
        var n = 0;
        try {
          for (var r = h(this.draggables.toArray()), o = r.next(); !o.done; o = r.next()) {
            var i = o.value,
              a = i.element,
      ...
      (e.prototype.onDragging = function (e) {
        ...
        var t = e.model,
          n = e.event,
          r = this.positions[t.prop],
          o = this.isTarget(t, n);
        o
          ? this.lastDraggingIndex !== o.i &&
            (this.targetChanged.emit({ prevIndex: this.lastDraggingIndex, newIndex: o.i, initialIndex: r.index }),
            (this.lastDraggingIndex = o.i))
          : this.lastDraggingIndex !== r.index &&
            (this.targetChanged.emit({ prevIndex: this.lastDraggingIndex, initialIndex: r.index }),
            (this.lastDraggingIndex = r.index));
      }),
      (e.prototype.onDragEnd = function (e) {
        var t = e.element,
          ...
          i = this.isTarget(n, r);
        i && this.reorder.emit({ prevIndex: o.index, newIndex: i.i, model: n }),
      ...
      (e.prototype.isTarget = function (e, t) {
        var n = 0,
          r = t.x || t.clientX,
          o = t.y || t.clientY,
          i = this.document.elementsFromPoint(r, o),
          a = function (t) {
            var r = s.positions[t];
            if (
              e.prop !== t &&
  ...
  (f.decorators = [{ type: t.Directive, args: [{ selector: '[orderable]' }] }]),
    ...
    (f.propDecorators = {
      ...
      draggables: [{ type: t.ContentChildren, args: [u, { descendants: !0 }] }]
    });
  var y = (function () {
    function e() {
      (this.pressEnabled = !0),
    ...
    return (
      ...
      (e.prototype.onMouseDown = function (e) {
        ...
        if (1 === e.which && this.pressEnabled && !e.target.classList.contains('resize-handle')) {
          ...
          var n = r.fromEvent(document, 'mouseup');
  ...
  (y.decorators = [{ type: t.Directive, args: [{ selector: '[long-press]' }] }]),
    (y.propDecorators = {
  ...
  (b.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-group-header-template]' }] }]),
  ...
  function x(e) {
    return null == e ? v : 'number' == typeof e ? C : -1 !== e.indexOf('.') ? S : I;
  }
  function C(e, t) {
    if (null == e) return '';
  ...
  function S(e, t) {
    ...
    n = e;
    var r = t.split('.');
    if (r.length) for (var o = 0; o < r.length; o++) if (null == (n = n[r[o]])) return '';
    return n;
  }
  function P(e) {
    return (
    ...
    if (t && n) {
      ...
      for (
        var a = e.reduce(function (e, t) {
            var r = n(t);
            return -1 === e.indexOf(r) && e.push(r), e;
          }, []),
          s = 0;
        s < o;
        s++
  ...
  (w.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-group-header' }] }]),
    (w.propDecorators = {
      rowHeight: [{ type: t.Input }],
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [b, { read: t.TemplateRef, static: !0 }] }],
        ...
        (e.prototype.flatten = function (e, t) {
          if ('expanded' === this.row.treeStatus)
            for (var n = 0, r = this.children.length; n < r; n++) {
              ...
              e.apply(o, Array.prototype.slice.call(arguments, 2)), t && o.flatten.apply(o, arguments);
            }
        }),
        e
      );
  ...
  function j(e) {
    ...
    if (e) {
      var r = !1;
      try {
        for (var o = h(e), i = o.next(); !i.done; i = o.next()) {
          var a = i.value;
          a.$$id || (a.$$id = z()),
            M(a.prop) && a.name && (a.prop = O(a.name)),
            a.$$valueGetter || (a.$$valueGetter = x(a.prop)),
            !M(a.prop) && M(a.name) && (a.name = k(String(a.prop))),
            M(a.prop) && M(a.name) && (a.name = ''),
            ...
            a.hasOwnProperty('isTreeColumn') && a.isTreeColumn && !r ? (r = !0) : (a.isTreeColumn = !1);
        }
      } catch (e) {
        t = { error: e };
      } finally {
  ...
  function B(e) {
    var t,
      ...
      i = [];
    try {
      for (var a = h(e), s = a.next(); !s.done; s = a.next()) {
        var l = s.value,
          c = {},
          u = Object.getOwnPropertyNames(l);
        try {
          for (var p = ((r = void 0), h(u)), d = p.next(); !d.done; d = p.next()) {
            var g = d.value;
            c[g] = l[g];
          }
        } catch (e) {
  ...
  ((R = e.ColumnMode || (e.ColumnMode = {})).standard = 'standard'),
    (R.flex = 'flex'),
    (R.force = 'force'),
    ((D = e.SelectionType || (e.SelectionType = {})).single = 'single'),
    (D.multi = 'multi'),
    (D.multiClick = 'multiClick'),
    (D.cell = 'cell'),
    (D.checkbox = 'checkbox'),
    ((H = e.SortType || (e.SortType = {})).single = 'single'),
    (H.multi = 'multi'),
    ((E = e.ContextmenuType || (e.ContextmenuType = {})).header = 'header'),
    (E.body = 'body');
  var A = function (e) {
    this.template = e;
  };
  (A.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-header-template]' }] }]),
  ...
  (W.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-cell-template]' }] }]),
  ...
  (F.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-tree-toggle]' }] }]),
    (F.ctorParameters = function () {
      return [{ type: t.TemplateRef }];
    });
  var V = (function () {
  ...
  (V.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-column' }] }]),
    ...
    (V.propDecorators = {
      ...
      _cellTemplateQuery: [{ type: t.ContentChild, args: [W, { read: t.TemplateRef, static: !0 }] }],
      _headerTemplateInput: [{ type: t.Input, args: ['headerTemplate'] }],
      _headerTemplateQuery: [{ type: t.ContentChild, args: [A, { read: t.TemplateRef, static: !0 }] }],
      _treeToggleTemplateInput: [{ type: t.Input, args: ['treeToggleTemplate'] }],
      _treeToggleTemplateQuery: [{ type: t.ContentChild, args: [F, { read: t.TemplateRef, static: !0 }] }]
    });
  var $ = function (e) {
    this.template = e;
  };
  ($.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-row-detail-template]' }] }]),
  ...
  (L.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-row-detail' }] }]),
    (L.propDecorators = {
      rowHeight: [{ type: t.Input }],
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [$, { read: t.TemplateRef, static: !0 }] }],
      toggle: [{ type: t.Output }]
    });
  var G = (function () {
    function e() {}
  ...
  function X(e) {
    ...
    if (e)
      try {
        for (var o = h(e), i = o.next(); !i.done; i = o.next()) {
          var a = i.value;
          a.frozenLeft ? r.left.push(a) : a.frozenRight ? r.right.push(a) : r.center.push(a);
        }
      } catch (e) {
        t = { error: e };
      } finally {
  ...
  function N(e, t) {
    return { left: K(e.left), center: K(e.center), right: K(e.right), total: Math.floor(K(t)) };
  }
  function K(e, t) {
    var n,
      r,
    ...
    if (e)
      try {
        for (var i = h(e), a = i.next(); !a.done; a = i.next()) {
          var s = a.value,
            l = t && s[t] ? s[t] : s.width;
          o += parseFloat(l);
        }
  ...
  (G.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-footer' }] }]),
    (G.propDecorators = {
      ...
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [l, { read: t.TemplateRef }] }]
    });
  var q = (function () {
      function e() {
        this.treeArray = [];
      ...
      return (
        ...
        (e.prototype.calcRowIndex = function (e) {
          ...
          for (var t = -1, n = this.treeArray.length, r = Math.pow(2, n.toString(2).length - 1); 0 !== r; r >>= 1) {
            var o = t + r;
            o < n && e >= this.treeArray[o] && ((e -= this.treeArray[o]), (t = o));
          }
          return t + 1;
        }),
        e
    ...
    Q = {},
    Z = 'undefined' != typeof document ? document.createElement('div').style : void 0,
    J = function () {
      var e = 'undefined' != typeof window ? window.getComputedStyle(document.documentElement, '') : void 0,
        t =
          void 0 !== e
            ...
            : null,
        n = null !== t ? t[1] : void 0,
        r = void 0 !== n ? 'WebKit|Moz|MS|O'.match(new RegExp('(' + n + ')', 'i'))[1] : void 0;
      return r ? { dom: r, lowercase: n, css: '-' + n + '-', js: n[0].toUpperCase() + n.substr(1) } : void 0;
    },
    ee = J();
  function te(e) {
    var t = O(e);
    return (
      Q[t] || (void 0 !== ee && void 0 !== Z[ee.css + e] ? (Q[t] = ee.css + e) : void 0 !== Z[e] && (Q[t] = e)), Q[t]
    );
  }
  var ne = 'undefined' != typeof window ? te('transform') : void 0,
    re = 'undefined' != typeof window ? te('backfaceVisibility') : void 0,
    oe = 'undefined' != typeof window ? !!te('transform') : void 0,
    ie = 'undefined' != typeof window ? !!te('perspective') : void 0,
    ae = 'undefined' != typeof window ? window.navigator.userAgent : 'Chrome',
    se = /Safari\//.test(ae) && !/Chrome\//.test(ae);
  function le(e, t, n) {
    void 0 !== ne && oe
      ? !se && ie
        ? ((e[ne] = 'translate3d(' + t + 'px, ' + n + 'px, 0)'), (e[re] = 'hidden'))
        : (e[O(ne)] = 'translate(' + t + 'px, ' + n + 'px)')
    ...
    function e(e) {
      ...
      (this.cd = e),
        ...
        (this.getDetailRowHeight = function (e, t) {
          ...
          var r = n.rowDetail.rowHeight;
          return 'function' == typeof r ? r(e, t) : r;
        }),
        (this.rowTrackingFn = function (e, t) {
          var r = n.getRowIndex(t);
          return n.trackByProp ? t[n.trackByProp] : r;
        });
    }
    return (
      ...
      (e.prototype.ngOnInit = function () {
        ...
        this.rowDetail &&
          (this.listener = this.rowDetail.toggle.subscribe(function (t) {
            var n = t.type,
              r = t.value;
            'row' === n && e.toggleRowExpansion(r),
              'all' === n && e.toggleAllRows(r),
              e.updateIndexes(),
              e.updateRows(),
              e.cd.markForCheck();
          })),
          this.groupHeader &&
            (this.listener = this.groupHeader.toggle.subscribe(function (t) {
              var n = t.type,
                r = t.value;
              'group' === n && e.toggleRowExpansion(r),
                'all' === n && e.toggleAllRows(r),
                e.updateIndexes(),
                e.updateRows(),
                e.cd.markForCheck();
      ...
      (e.prototype.updateRows = function () {
        ...
        if (this.groupedRows) {
          for (
            ...
            var s = this.groupedRows[o];
            this.rowIndexes.set(s, o),
              s.value &&
                s.value.forEach(function (t, n) {
                  var r = o + '-' + n;
                  e.rowIndexes.set(t, r);
                }),
              (a[i] = s),
              i++,
              o++;
          ...
          for (; o < r && o < this.rowCount; ) {
            var l = this.rows[o];
            l && (this.rowIndexes.set(l, o), (a[i] = l)), i++, o++;
          }
        this.temp = a;
      }),
      ...
      (e.prototype.getRowsStyles = function (e) {
        ...
        if ((this.groupedRows && (t.width = this.columnGroupWidths.total), this.scrollbarV && this.virtualization)) {
          ...
          if (this.groupedRows) {
            var r = e[e.length - 1];
            n = r ? this.getRowIndex(r) : 0;
          } else n = this.getRowIndex(e);
          le(t, 0, this.rowHeightsCache.query(n - 1));
        }
        return t;
      }),
      (e.prototype.getBottomSummaryRowStyles = function () {
        ...
        return le(e, 0, this.rowHeightsCache.query(this.rows.length - 1)), e;
      }),
      ...
      (e.prototype.refreshRowHeightCache = function () {
        ...
        if (
          ...
          var n = new Set();
          try {
            for (var r = h(this.rows), o = r.next(); !o.done; o = r.next()) {
              var i = o.value;
      ...
      (e.prototype.toggleRowExpansion = function (e) {
        ...
        if (this.scrollbarV && this.virtualization) {
          var o = this.getDetailRowHeight(e) * (r ? -1 : 1),
            i = this.getRowIndex(e);
          this.rowHeightsCache.update(i, o);
        }
        r ? this.rowExpansions.splice(n, 1) : this.rowExpansions.push(e),
          this.detailToggle.emit({ rows: [e], currentIndex: t });
      }),
      (e.prototype.toggleAllRows = function (e) {
        var t, n;
        this.rowExpansions = [];
        var r = this.getAdjustedViewPortIndex();
        if (e)
          try {
            for (var o = h(this.rows), i = o.next(); !i.done; i = o.next()) {
              var a = i.value;
      ...
      (e.prototype.stylesByGroup = function (e) {
        ...
        if ('left' === e) le(r, n, 0);
          ...
          var o = parseInt(this.innerWidth + '', 0);
          le(r, -1 * (t.total - o - n), 0);
        }
        return r;
      }),
      (e.prototype.getRowExpanded = function (e) {
        ...
        if (0 === this.rowExpansions.length && this.groupExpansionDefault)
          try {
            for (var r = h(this.groupedRows), o = r.next(); !o.done; o = r.next()) {
              var i = o.value;
      ...
      (e.prototype.getRowExpandedIdx = function (e, t) {
        ...
        var r = this.rowIdentity(e);
        return t.findIndex(function (e) {
          return n.rowIdentity(e) === r;
        });
      }),
      (e.prototype.getRowIndex = function (e) {
  ...
  (ce.decorators = [
    ...
    (ce.propDecorators = {
      ...
      scroller: [{ type: t.ViewChild, args: [m] }]
    });
  var ue,
    pe = (function () {
      function n(e) {
      ...
      return (
          ...
          set: function (e) {
            ...
            (this._innerWidth = e),
              setTimeout(function () {
                if (t._columns) {
                  var e = X(t._columns);
                  (t._columnGroupWidths = N(e, t._columns)), t.setStylesByGroup();
                }
              });
          },
          enumerable: !1,
        ...
        Object.defineProperty(n.prototype, 'columns', {
          ...
          set: function (e) {
            ...
            this._columns = e;
            var n = X(e);
            (this._columnsByPin = U(e)),
              setTimeout(function () {
                (t._columnGroupWidths = N(n, e)), t.setStylesByGroup();
              });
          },
          enumerable: !1,
          configurable: !0
        ...
        (n.prototype.onColumnReordered = function (e) {
          var t = e.prevIndex,
            ...
            o = this.getColumn(n);
          (o.isTarget = !1),
            (o.targetMarkerContext = void 0),
            this.reorder.emit({ column: r, prevValue: t, newValue: n });
        }),
        (n.prototype.onTargetChanged = function (e) {
          ...
          if (t || 0 === t) {
            ...
            (o.isTarget = !1), (o.targetMarkerContext = void 0);
          }
          if (n || 0 === n) {
            var i = this.getColumn(n);
            (i.isTarget = !0),
              r !== n &&
                (i.targetMarkerContext = { class: 'targetMarker '.concat(r > n ? 'dragFromRight' : 'dragFromLeft') });
          }
        }),
        ...
        (n.prototype.onSort = function (e) {
          var t = e.column,
            ...
            r = e.newValue;
          if (!t.dragging) {
            var o = this.calcNewSorts(t, n, r);
            this.sort.emit({ sorts: o, column: t, prevValue: n, newValue: r });
          }
        }),
        (n.prototype.calcNewSorts = function (t, n, r) {
          var o = 0;
          this.sorts || (this.sorts = []);
          var i = this.sorts.map(function (e, n) {
            return (e = Object.assign({}, e)).prop === t.prop && (o = n), e;
          });
          return (
            void 0 === r
              ? i.splice(o, 1)
        ...
        (n.prototype.calcStylesByGroup = function (e) {
          var t = this._columnGroupWidths,
            n = this.offsetX,
            r = { width: t[e] + 'px' };
          if ('center' === e) le(r, -1 * n, 0);
          else if ('right' === e) {
            le(r, -1 * (t.total - this.innerWidth), 0);
          }
          return r;
        }),
        n
  ...
  function he(e, t, n) {
    ...
    var a = null,
      s = 0;
    function l() {
      (s = !1 === n.leading ? 0 : +new Date()), (a = null), (i = e.apply(r, o));
    }
    return function () {
      var c = +new Date();
      s || !1 !== n.leading || (s = c);
      ...
      return (
        ...
        (o = arguments),
        u <= 0
          ? (clearTimeout(a), (a = null), (s = c), (i = e.apply(r, o)))
  ...
  function de(e, t) {
    return function (n, r, o) {
      return {
        ...
        get: function () {
          return (
            Object.defineProperty(this, r, { configurable: !0, enumerable: o.enumerable, value: he(o.value, e, t) }),
            this[r]
          );
        }
      };
  ...
  function fe(e, t) {
    ...
    n !== t &&
      (function (e, t, n) {
        ...
        for (var s in e)
          try {
            for (var l = ((r = void 0), h(e[s])), c = l.next(); !c.done; c = l.next()) {
              (y = c.value).canAutoResize ? (y.width = 0) : ((t -= y.width), (n -= y.flexGrow ? y.flexGrow : 0));
            }
          } catch (e) {
            r = { error: e };
          } finally {
        ...
        do {
          ...
          for (var s in ((p = 0), e))
            try {
              for (var g = ((i = void 0), h(e[s])), f = g.next(); !f.done; f = g.next()) {
                var y;
                if ((y = f.value).canAutoResize && !u[y.prop]) {
                  var m = y.width + y.flexGrow * d;
                  void 0 !== y.minWidth && m < y.minWidth
                    ? ((p += m - y.minWidth), (y.width = y.minWidth), (u[y.prop] = !0))
                    : (y.width = m);
                }
              }
            } catch (e) {
  ...
  function ye(e, t, n, r, o) {
    ...
    try {
      for (var u = h(c), p = u.next(); !p.done; p = u.next()) {
    ...
    do {
      (d = y / c.length), (g = f >= t);
      try {
        for (var b = ((s = void 0), h(c)), w = b.next(); !w.done; w = b.next()) {
          var v = w.value;
          if (g && r) v.width = v.$$oldWidth || v.width || o;
          else {
            var x = (v.width || o) + d;
            v.minWidth && x < v.minWidth
              ? ((v.width = v.minWidth), m.push(v))
              : v.maxWidth && x > v.maxWidth
              ? ((v.width = v.maxWidth), m.push(v))
              : (v.width = x);
          }
  ...
  function xe(t, n, r) {
    ...
    var i = g(t),
      ...
      s = r.map(function (e) {
        var t = e.prop;
        return { prop: t, dir: e.dir, valueGetter: x(t), compareFn: a[t] || ve };
      });
    return i.sort(function (t, n) {
      var r, i;
      try {
        for (var a = h(s), l = a.next(); !l.done; l = a.next()) {
          var c = l.value,
            u = c.prop,
            p = c.valueGetter,
            d = p(t, u),
            g = p(n, u),
            f = c.dir !== e.SortDirection.desc ? c.compareFn(d, g, t, n, c.dir) : -c.compareFn(d, g, t, n, c.dir);
          if (0 !== f) return f;
        }
      } catch (e) {
        r = { error: e };
      ...
      return o.has(t) && o.has(n) ? (o.get(t) < o.get(n) ? -1 : 1) : 0;
    });
  }
  (pe.decorators = [
    {
    ...
    ((ue = e.SortDirection || (e.SortDirection = {})).asc = 'asc'),
    (ue.desc = 'desc');
  var Ce = (function () {
    function n(n, o, i, a, s, l, c) {
      var u = this;
      (this.scrollbarHelper = n),
        ...
        (this.treeAction = new t.EventEmitter()),
        (this.rowCount = 0),
        (this._offsetX = new r.BehaviorSubject(0)),
        (this._count = 0),
        (this._offset = 0),
        (this._subscriptions = []),
    ...
    return (
      Object.defineProperty(n.prototype, 'rows', {
        ...
        set: function (e) {
          (this._rows = e),
            e && (this._internalRows = g(e)),
            this.externalSorting || this.sortInternalRows(),
            (this._internalRows = T(this._internalRows, P(this.treeFromRelation), P(this.treeToRelation))),
            this.recalculate(),
      ...
      Object.defineProperty(n.prototype, 'columns', {
        ...
        set: function (e) {
          e && ((this._internalColumns = g(e)), j(this._internalColumns), this.recalculateColumns()),
            (this._columns = e);
        },
        enumerable: !1,
        configurable: !0
      ...
      (n.prototype.translateColumns = function (e) {
        if (e) {
          var t = e.toArray();
          t.length &&
            ((this._internalColumns = B(t)),
            j(this._internalColumns),
      ...
      (n.prototype.groupArrayBy = function (e, t) {
        ...
        e.forEach(function (e) {
          var r = e[t];
          n.has(r) ? n.get(r).push(e) : n.set(r, [e]);
        });
      ...
      (n.prototype.ngDoCheck = function () {
        this.rowDiffer.diff(this.rows) &&
          (this.externalSorting ? (this._internalRows = g(this.rows)) : this.sortInternalRows(),
          (this._internalRows = T(this._internalRows, P(this.treeFromRelation), P(this.treeToRelation))),
      ...
      (n.prototype.recalculateColumns = function (t, n, r) {
        if (
          (void 0 === t && (t = this._internalColumns),
          void 0 === n && (n = -1),
          void 0 === r && (r = this.scrollbarH),
          t)
        ) {
          var o = this._innerWidth;
          return (
            this.scrollbarV && (o -= this.scrollbarHelper.width),
            this.columnMode === e.ColumnMode.force ? ye(t, o, n, r) : this.columnMode === e.ColumnMode.flex && fe(t, o),
            t
          );
        }
      }),
      ...
      (n.prototype.onColumnContextmenu = function (t) {
        var n = t.event,
          r = t.column;
        this.tableContextmenu.emit({ event: n, type: e.ContextmenuType.header, content: r });
      }),
      (n.prototype.onRowContextmenu = function (t) {
        var n = t.event,
          r = t.row;
        this.tableContextmenu.emit({ event: n, type: e.ContextmenuType.body, content: r });
      }),
      (n.prototype.onColumnResize = function (e) {
        ...
        if (void 0 !== t) {
          var r,
            o = this._internalColumns.map(function (e, o) {
              return (e = Object.assign({}, e)).$$id === t.$$id && ((r = o), (e.width = n), (e.$$oldWidth = n)), e;
            });
          this.recalculateColumns(o, r), (this._internalColumns = o), this.resize.emit({ column: t, newValue: n });
        }
      }),
      (n.prototype.onColumnReorder = function (e) {
        var t = e.column,
          n = e.newValue,
          r = e.prevValue,
          o = this._internalColumns.map(function (e) {
        ...
        if (this.swapColumns) {
          ...
          for (var a = o[r], s = r; s < n; s++) o[s] = o[s + 1];
          o[n] = a;
        } else {
          for (a = o[r], s = r; s > n; s--) o[s] = o[s - 1];
          o[n] = a;
        }
        (this._internalColumns = o), this.reorder.emit({ column: t, newValue: n, prevValue: r });
      }),
      ...
      (n.prototype.onHeaderSelect = function (e) {
        var t, n;
        if (this.bodyComponent && this.selectAllRowsOnPage) {
          var r = this.bodyComponent.indexes.first,
            o = this.bodyComponent.indexes.last,
            i = this.selected.length === o - r;
          (this.selected = []), i || (t = this.selected).push.apply(t, g(this._internalRows.slice(r, o)));
        } else {
          i = this.selected.length === this.rows.length;
          (this.selected = []), i || (n = this.selected).push.apply(n, g(this.rows));
        }
      ...
      (n.prototype.onTreeAction = function (e) {
        var t = this,
          n = e.row,
          r = this._rows.findIndex(function (n) {
            return n[t.treeToRelation] === e.row[t.treeToRelation];
          });
        this.treeAction.emit({ row: n, rowIndex: r });
      }),
      (n.prototype.ngOnDestroy = function () {
      ...
      (n.prototype.sortInternalRows = function () {
        this._internalRows = xe(this._internalRows, this._internalColumns, this.sorts);
      }),
      n
    );
  })();
  (Ce.decorators = [
    ...
    (Ce.ctorParameters = function () {
      return [
        { type: i, decorators: [{ type: t.SkipSelf }] },
        { type: a, decorators: [{ type: t.SkipSelf }] },
    ...
    (Ce.propDecorators = {
      ...
      columnTemplates: [{ type: t.ContentChildren, args: [V] }],
      rowDetail: [{ type: t.ContentChild, args: [L] }],
      groupHeader: [{ type: t.ContentChild, args: [w] }],
      footer: [{ type: t.ContentChild, args: [G] }],
      bodyComponent: [{ type: t.ViewChild, args: [ce] }],
      headerComponent: [{ type: t.ViewChild, args: [pe] }],
      rowIdentity: [{ type: t.Input }],
    ...
    })([de(5)], Ce.prototype, 'onWindowResize', null);
  var Ie = (function () {
    function n(e) {
      (this.cd = e),
        (this.sort = new t.EventEmitter()),
    ...
    return (
        ...
        get: function () {
          ...
          if (
            ...
            if ('string' == typeof this.column.headerClass) n += ' ' + this.column.headerClass;
              ...
              var r = this.column.headerClass({ column: this.column });
      ...
      (n.prototype.onSort = function () {
        if (this.column.sortable) {
          var e = we(this.sortType, this.sortDir);
      ...
      (e.prototype.calcPages = function (e) {
        ...
        (e = e || this.page),
          o &&
            ...
            (r = e + Math.floor(2.5)),
            n < 1
              ? ((n = 1), (r = Math.min(n + 5 - 1, this.totalPages)))
              : r > this.totalPages && ((n = Math.max(this.totalPages - 5 + 1, 1)), (r = this.totalPages)));
        for (var i = n; i <= r; i++) t.push({ number: i, text: i });
        return t;
      }),
      e
    );
  ...
  (Re.decorators = [
    ...
    ((Te = e.Keys || (e.Keys = {}))[(Te.up = 38)] = 'up'),
    (Te[(Te.down = 40)] = 'down'),
    (Te[(Te.return = 13)] = 'return'),
    (Te[(Te.escape = 27)] = 'escape'),
    (Te[(Te.left = 37)] = 'left'),
    (Te[(Te.right = 39)] = 'right');
  var De = (function () {
    function n(e, n, r, o) {
      (this.differs = e),
        (this.scrollbarHelper = n),
    ...
    return (
      ...
      Object.defineProperty(n.prototype, 'innerWidth', {
        ...
        set: function (e) {
          if (this._columns) {
            var t = X(this._columns);
            this._columnGroupWidths = N(t, this._columns);
          }
      ...
      (n.prototype.calcStylesByGroup = function (e) {
        ...
        if ('left' === e) le(r, n, 0);
          ...
          var o = parseInt(this.innerWidth + '', 0);
          le(r, -1 * (t.total - o - n + this.scrollbarHelper.width), 0);
        }
        return r;
      }),
      ...
      (n.prototype.recalculateColumns = function (e) {
        ...
        var t = X(this._columns);
        (this._columnsByPin = U(this._columns)), (this._columnGroupWidths = N(t, this._columns));
      }),
    ...
    return (
      ...
      Object.defineProperty(n.prototype, 'columnCssClasses', {
        get: function () {
          var t,
            n,
            r = 'datatable-body-cell';
          if (this.column.cellClass)
            if ('string' == typeof this.column.cellClass) r += ' ' + this.column.cellClass;
            else if ('function' == typeof this.column.cellClass) {
              var o = this.column.cellClass({
                row: this.row,
                group: this.group,
                column: this.column,
                value: this.value,
              ...
              if ('string' == typeof o) r += ' ' + o;
                ...
                var i = Object.keys(o);
                try {
                  for (var a = h(i), s = a.next(); !s.done; s = a.next()) {
                    var l = s.value;
                    !0 === o[l] && (r += ' ' + l);
                  }
                } catch (e) {
          ...
          return (
            this.sortDir || (r += ' sort-active'),
            this.isFocused && (r += ' active'),
            this.sortDir === e.SortDirection.asc && (r += ' sort-asc'),
            this.sortDir === e.SortDirection.desc && (r += ' sort-desc'),
            r
          );
        },
        enumerable: !1,
  ...
  function _e(e, t, n) {
    var r = n(t, e);
    return r > -1 ? e.splice(r, 1) : e.push(t), e;
  }
  function Oe(e, t, n, r, o) {
    for (var i = n < r, a = 0; a < t.length; a++) {
      var s = t[a],
        l = { start: 0, end: 0 };
      (l = i ? { start: n, end: r } : { start: r, end: n + 1 }),
        ((i && a <= r && a >= n) || (!i && a >= r && a <= n)) && a >= l.start && a <= l.end && e.push(s);
    }
    return e;
  }
  (Ee.decorators = [
    ...
    (Ee.ctorParameters = function () {
      return [{ type: t.ElementRef }, { type: t.ChangeDetectorRef }];
    }),
    (Ee.propDecorators = {
      displayCheck: [{ type: t.Input }],
      group: [{ type: t.Input }],
  ...
  var ke = (function () {
    ...
    return (
      (n.prototype.selectRow = function (t, n, r) {
        var o;
        if (this.selectEnabled) {
          ...
          (l =
            a || i || s
              ? t.shiftKey
                ? Oe([], this.rows, n, this.prevIndex, this.getRowSelectedIdx.bind(this))
                : t.ctrlKey || t.metaKey || s || i
                ? _e(g(this.selected), r, this.getRowSelectedIdx.bind(this))
                : _e([], r, this.getRowSelectedIdx.bind(this))
              : _e([], r, this.getRowSelectedIdx.bind(this))),
            'function' == typeof this.selectCheck && (l = l.filter(this.selectCheck.bind(this))),
            this.selected.splice(0, this.selected.length),
            (o = this.selected).push.apply(o, g(l)),
            (this.prevIndex = n),
      ...
      (n.prototype.onActivate = function (t, n) {
        ...
        (!a && ('click' === r || 'dblclick' === r)) || (a && 'checkbox' === r)
          ? this.selectRow(o, n, i)
          : 'keydown' === r && (o.keyCode === e.Keys.return ? this.selectRow(o, n, i) : this.onKeyboardFocus(t)),
      ...
      (n.prototype.onKeyboardFocus = function (t) {
        ...
        if (n === e.Keys.up || n === e.Keys.down || n === e.Keys.right || n === e.Keys.left) {
          var r = this.selectionType === e.SelectionType.cell;
          t.cellElement && r
            ? r && this.focusCell(t.cellElement, t.rowElement, n, t.cellIndex)
      ...
      (n.prototype.getPrevNextRow = function (t, n) {
        ...
        if (r) {
          var o = void 0;
          if (
            (n === e.Keys.up ? (o = r.previousElementSibling) : n === e.Keys.down && (o = r.nextElementSibling),
            o && o.children.length)
          )
            return o.children[0];
        }
      }),
      (n.prototype.focusCell = function (t, n, r, o) {
        var i;
        if (r === e.Keys.left) i = t.previousElementSibling;
        else if (r === e.Keys.right) i = t.nextElementSibling;
        else if (r === e.Keys.up || r === e.Keys.down) {
          var a = this.getPrevNextRow(n, r);
          if (a) {
          ...
          this.columns
            ...
            .forEach(function (t) {
              var n = e.rows.map(function (e) {
                ...
                r = e.getSummaryFunction(t);
              e.summaryRow[t.prop] = t.pipe ? t.pipe.transform(r(n)) : r(n);
            });
      }),
      (e.prototype.getSummaryFunction = function (e) {
        return void 0 === e.summaryFunc ? ze : null === e.summaryFunc ? je : e.summaryFunc;
      }),
      e
    );
  })();
  ...
  function We(e, t) {
    for (var n, r, o, i = [], a = []; (n = document.elementFromPoint(e, t)) && -1 === i.indexOf(n) && null != n; )
      i.push(n),
        a.push({
    ...
    for (r = a.length; (o = a[--r]); ) i[r].style.setProperty('pointer-events', o.value ? o.value : '', o.priority);
    return i;
  }
  (Ae.decorators = [
    {
      ...
      args: [
        {
          ...
          exports: [Ce, L, w, $, V, A, W, F, l, G, Pe, b]
        }
      ]
    }
  ]),
    ((Be = e.ClickType || (e.ClickType = {})).single = 'single'),
    (Be.double = 'double'),
    'undefined' == typeof document || document.elementsFromPoint || (document.elementsFromPoint = We),
    (e.ColumnChangesService = s),
    (e.DataTableBodyCellComponent = Ee),
    (e.DataTableBodyComponent = ce),
    (e.DataTableBodyRowComponent = De),
    (e.DataTableColumnCellDirective = W),
    (e.DataTableColumnCellTreeToggle = F),
    (e.DataTableColumnDirective = V),
    (e.DataTableColumnHeaderDirective = A),
    (e.DataTableFooterComponent = Se),
    (e.DataTableFooterTemplateDirective = l),
    (e.DataTableHeaderCellComponent = Ie),
    (e.DataTableHeaderComponent = pe),
    (e.DataTablePagerComponent = Pe),
    (e.DataTableRowWrapperComponent = He),
    (e.DataTableSelectionComponent = ke),
    (e.DataTableSummaryRowComponent = Me),
    (e.DatatableComponent = Ce),
    (e.DatatableFooterDirective = G),
    (e.DatatableGroupHeaderDirective = w),
    (e.DatatableGroupHeaderTemplateDirective = b),
    (e.DatatableRowDetailDirective = L),
    (e.DatatableRowDetailTemplateDirective = $),
    (e.DimensionsHelper = a),
    (e.DraggableDirective = u),
    (e.LongPressDirective = y),
    (e.NgxDatatableModule = Ae),
    (e.OrderableDirective = f),
    (e.ProgressBarComponent = Re),
    (e.ResizeableDirective = p),
    (e.RowHeightCache = q),
    (e.ScrollbarHelper = i),
    (e.ScrollerComponent = m),
    (e.VisibilityDirective = c),
    (e.adjustColumnWidths = fe),
    (e.camelCase = O),
    (e.columnGroupWidths = N),
    (e.columnTotalWidth = K),
    (e.columnsByPin = X),
    (e.columnsByPinArr = U),
    (e.columnsTotalWidth = Y),
    (e.deCamelCase = k),
    (e.deepValueGetter = S),
    (e.elementsFromPoint = We),
    (e.emptyStringGetter = v),
    (e.forceFillColumnWidths = ye),
    (e.getTotalFlexGrow = ge),
    (e.getVendorPrefixedName = te),
    (e.getterForProp = x),
    (e.groupRowsByParents = T),
    (e.id = z),
    (e.isNullOrUndefined = M),
    (e.nextSortDir = we),
    (e.numericIndexGetter = C),
    (e.optionalGetterForProp = P),
    (e.orderByComparator = ve),
    (e.selectRows = _e),
    (e.selectRowsBetween = Oe),
    (e.setColumnDefaults = j),
    (e.shallowValueGetter = I),
    (e.sortRows = xe),
    (e.throttle = he),
    (e.throttleable = de),
    (e.translateTemplates = B),
    (e.translateXY = le),
    (e.ɵ0 = J),
