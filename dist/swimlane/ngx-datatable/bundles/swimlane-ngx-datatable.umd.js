    ...
    var DatatableComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this._subscriptions.push(this.recalculate$
                .pipe(operators.throttleTime(250, rxjs.asyncScheduler, { leading: true, trailing: true }), operators.delay(100))
                .subscribe((/**
             * @return {?}
             */
