(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@swimlane/ngx-datatable', ['exports', '@angular/core', '@angular/common', '@angular/material/icon', '@angular/material/button', '@angular/cdk/overlay', '@angular/material/tooltip', 'rxjs', 'rxjs/operators', '@angular/platform-browser', '@angular/cdk/portal'], factory) :
    (global = global || self, factory((global.swimlane = global.swimlane || {}, global.swimlane['ngx-datatable'] = {}), global.ng.core, global.ng.common, global.ng.material.icon, global.ng.material.button, global.ng.cdk.overlay, global.ng.material.tooltip, global.rxjs, global.rxjs.operators, global.ng.platformBrowser, global.ng.cdk.portal));
}(this, function (exports, core, common, icon, button, overlay, tooltip, rxjs, operators, platformBrowser, portal) { 'use strict';
    ...
    var NgxDatatableModule = /** @class */ (function () {
        ...
        NgxDatatableModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, tooltip.MatTooltipModule, overlay.OverlayModule, icon.MatIconModule, button.MatButtonModule],
