(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory(
        ((global.stage = global.stage || {}), (global.stage['ngx-datatable'] = {})),
        global.ng.core,
        global.ng.common,
        global.ng.material.icon,
        global.ng.material.button,
        global.ng.cdk.overlay,
  ...
  function (
    ...
    ***************************************************************************** */
    ...
    var DataTableHeaderComponent = /** @class */ (function () {
      ...
      DataTableHeaderComponent.prototype.onColumnFilter = function (event) {
    ...
    var DataTableHeaderCellComponent = /** @class */ (function () {
      ...
      DataTableHeaderCellComponent.prototype.setFilter = function (column) {
        this.filter.emit({
          column: column,
          value: this.filterCache[column]
        });
      };
      DataTableHeaderCellComponent.prototype.resetFilter = function (column) {
    ...
    var DataTableBodyCellComponent = /** @class */ (function () {
      ...
      DataTableBodyCellComponent.prototype.middleclickEvent = function (event) {
        if (event.which === 2) {
          this.activate.emit({
            type: 'middleclick',
            event: event,
      ...
      DataTableBodyCellComponent.prototype.hasToShowToolTip = function (row, field) {
        return row && field && field.tooltip && field.tooltip.length > 0 && !!this.getTooltipValue(null, row, field);
      };
      DataTableBodyCellComponent.prototype.getTooltipValue = function (value, row, field) {
        if (row && field && field.tooltip && field.tooltip.length > 0) {
          return row['' + field.tooltip] || (!field.canHideTooltip && field.tooltip);
        }
        return value;
      };
      DataTableBodyCellComponent.prototype.getIcons = function (row, icons) {
        if (row && icons) {
      ...
      DataTableBodyCellComponent.prototype.selectFieldValue = function (row, prop) {
        if (row && prop) {
      ...
      DataTableBodyCellComponent.prototype.onClickRowActionButton = function (event, field, row) {
        if (field && row) {
          event.preventDefault();
          event.stopPropagation();
          field.action(row);
      ...
      DataTableBodyCellComponent.prototype.sanatizeHtml = function (html) {
        return this.sanitizer.bypassSecurityTrustHtml(html);
      };
      DataTableBodyCellComponent.prototype.isEditable = function (field, row) {
        if (field && row) {
      ...
      DataTableBodyCellComponent.prototype.updateSelect = function (field, row, newValue) {
      ...
      DataTableBodyCellComponent.prototype.editField = function (field, row, newValue) {
        var _a;
        field.onEdit(Object.assign(Object.assign({}, row), ((_a = {}), (_a[field.prop] = newValue), _a)));
      };
      DataTableBodyCellComponent.prototype.toggleExpandRow = function (row, event) {
        event.preventDefault();
        event.stopPropagation();
        if (this.rowDetail) {
      ...
      DataTableBodyCellComponent.prototype.onClickField = function (row, action, event) {
        if (row && action) {
          event.preventDefault();
          event.stopPropagation();
          action(row);
    ...
    DataTableBodyCellComponent.ctorParameters = function () {
      return [{ type: core.ElementRef }, { type: core.ChangeDetectorRef }, { type: platformBrowser.DomSanitizer }];
    };
    DataTableBodyCellComponent.propDecorators = {
      ...
      middleclickEvent: [{ type: core.HostListener, args: ['mouseup', ['$event']] }],
    ...
    DatatableFooterDirective.propDecorators = {
      ...
      _templateInput: [{ type: core.Input, args: ['template'] }],
      _templateQuery: [
        { type: core.ContentChild, args: [DataTableFooterTemplateDirective, { read: core.TemplateRef }] }
      ]
    };
    ...
    var CustomToolTipComponent = /** @class */ (function () {
      ...
      CustomToolTipComponent.prototype.hide = function () {
        if (this.onMouseLeave) {
          this.onMouseLeave();
        }
      };
      CustomToolTipComponent.prototype.show = function () {
    ...
    var ToolbarService = /** @class */ (function () {
      ...
      ToolbarService.prototype.setToolbar = function (
        _overlay,
      ...
      ToolbarService.prototype.clearTimeout = function () {
        if (this.timeout) {
          clearTimeout(this.timeout);
        }
      };
      ToolbarService.prototype.setTimeout = function (duration) {
        var _this = this;
        this.timeout = setTimeout(function () {
          _this.closeToolTip();
        }, duration);
      };
      ToolbarService.prototype.destroy = function () {
        this.clearTimeout();
        this.closeToolTip();
        this._overlayRef = null;
      };
      ToolbarService.prototype.closeToolTip = function () {
        if (this._overlayRef) {
    ...
    ToolbarService.decorators = [{ type: core.Injectable }];
    ...
    var ToolTipRendererDirective = /** @class */ (function () {
      ...
      ToolTipRendererDirective.prototype.show = function () {
      ...
      ToolTipRendererDirective.prototype.hide = function () {
        this.toolbarService.setTimeout(this.duration);
      };
      ToolTipRendererDirective.prototype.ngOnDestroy = function () {
        this.toolbarService.destroy();
      };
    ...
    ToolTipRendererDirective.propDecorators = {
      ...
      showToolTipOnTextOverflow: [{ type: core.Input }],
      duration: [{ type: core.Input }],
      show: [{ type: core.HostListener, args: ['mouseenter'] }],
      hide: [{ type: core.HostListener, args: ['mouseleave'] }]
    };
    ...
    var DatatableSelectComponent = /** @class */ (function () {
      ...
      Object.defineProperty(DatatableSelectComponent.prototype, 'value', {
        ...
        set: function (value) {
          this.currentClass = (
            this._options.find(function (option) {
      ...
      DatatableSelectComponent.prototype.ngOnInit = function () {
        if (!this.value) {
      ...
      DatatableSelectComponent.prototype.emitUpdate = function (newValue) {
        this.currentClass = (
          this._options.find(function (option) {
    ...
    var EditableTextComponent = /** @class */ (function () {
      ...
      EditableTextComponent.prototype.emitUpdate = function (newText) {
        if (!this.disabled) {
          this.update.emit(newText);
        }
      };
      EditableTextComponent.prototype.emitToggleEditing = function ($event) {
        $event.stopPropagation();
        if (!this.disabled) {
          this.editing = !this.editing;
        }
      };
      EditableTextComponent.prototype.emitFocus = function () {
        if (this.focus) {
          this.focus.emit(null);
        }
      };
      EditableTextComponent.prototype.emitToggleActive = function ($event) {
        $event.stopPropagation();
        if (!this.disabled) {
          this.active = !this.active;
        }
      };
      EditableTextComponent.prototype.ngAfterViewInit = function () {
        this.inputEl.changes.subscribe(function (d) {
    ...
    var DatatableComponent = /** @class */ (function () {
      ...
      DatatableComponent.prototype.ngOnInit = function () {
        ...
        if (cssElementQueries.ResizeSensor) {
          this.resizeSensor = new cssElementQueries.ResizeSensor(this.element, function () {
            return _this.recalculate$.next();
          });
        }
        this._subscriptions.push(
          this.recalculate$
            .pipe(
              operators.throttleTime(250, rxjs.asyncScheduler, { leading: true, trailing: true }),
              operators.delay(100)
            )
            .subscribe(function () {
      ...
      DatatableComponent.prototype.onColumnFilter = function (event) {
        this.filter.emit(event);
      };
      /**
...
//# sourceMappingURL=stage-ngx-datatable.umd.js.map
