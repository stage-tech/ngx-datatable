!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : t(
        (((e = 'undefined' != typeof globalThis ? globalThis : e || self).swimlane = e.swimlane || {}),
        (e.swimlane['ngx-datatable'] = {})),
        e.ng.core,
        e.ng.common,
        e.ng.material.icon,
  ...
  (w.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-footer-template]' }] }]),
  ...
  (v.decorators = [{ type: t.Directive, args: [{ selector: '[visibilityObserver]' }] }]),
  ...
  (we.decorators = [{ type: t.Directive, args: [{ selector: '[ngx-datatable-row-detail-template]' }] }]),
  ...
  (ve.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-row-detail' }] }]),
    (ve.propDecorators = {
      rowHeight: [{ type: t.Input }],
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [we, { read: t.TemplateRef, static: !0 }] }],
  ...
  (Pe.decorators = [{ type: t.Directive, args: [{ selector: 'ngx-datatable-footer' }] }]),
    (Pe.propDecorators = {
      ...
      pagerNextIcon: [{ type: t.Input }],
      _templateInput: [{ type: t.Input, args: ['template'] }],
      _templateQuery: [{ type: t.ContentChild, args: [w, { read: t.TemplateRef }] }]
    });
  var Oe = (function () {
    function e() {
      this.summaryRow = {};
  ...
  function Ue(e, t, n, o, r) {
    ...
    try {
      for (var u = I(c), p = u.next(); !p.done; p = u.next()) {
        (w = p.value).$$oldWidth || (w.$$oldWidth = w.width);
      }
    } catch (e) {
      i = { error: e };
    } finally {
    ...
    do {
      ...
      try {
        for (var m = ((s = void 0), I(c)), b = m.next(); !b.done; b = m.next()) {
          var w = b.value;
          if (d && o) w.width = w.$$oldWidth || w.width || r;
          else {
            var v = (w.width || r) + h;
            w.minWidth && v < w.minWidth
              ? ((w.width = w.minWidth), y.push(w))
              : w.maxWidth && v > w.maxWidth
              ? ((w.width = w.maxWidth), y.push(w))
              : (w.width = v);
          }
          w.width = Math.max(0, w.width);
        }
      } catch (e) {
        s = { error: e };
      } finally {
  ...
  (Ze.decorators = [
    ...
    (Ze.propDecorators = {
      ...
      rowDetail: [{ type: t.ContentChild, args: [ve] }],
  ...
  (et.decorators = [
      ...
      args: [
        {
          ...
          exports: [Ze, ve, Ce, we, _, D, O, H, w, Pe, ge, xe],
          entryComponents: [He]
        }
      ]
    }
    ...
    (e.DataTableFooterTemplateDirective = w),
    ...
    (e.DatatableRowDetailDirective = ve),
    (e.DatatableRowDetailTemplateDirective = we),
